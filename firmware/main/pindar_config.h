...
#define PINDAR_SPI_CS_IO_NUM GPIO_NUM_0
#define PINDAR_SPI_SCK_IO_NUM GPIO_NUM_3
#define PINDAR_SPI_MOSI_IO_NUM GPIO_NUM_1
#define PINDAR_SPI_MISO_IO_NUM GPIO_NUM_2
